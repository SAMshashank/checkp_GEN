...
const Chat = () => {
  ...
  return (
    ...
    >
      <button
        className="flex w-full cursor-pointer items-center justify-between bg-gradient-to-r from-yellow-400 via-orange-300 to-white  py-2 px-10 font-semibold text-black hover:text-white"
      ...
      >
        ...
        <motion.div
          animate={{ rotate: opened ? 180 : 0 }} // Rotate arrow on toggle
          transition={{ ease: DEFAULT_EASE, duration: 0.2 }}
        >
          <FaChevronDown />
        </motion.div>
      ...
      {/* Only show chat content if opened is true */}
      {opened && (
